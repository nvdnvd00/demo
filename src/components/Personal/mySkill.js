                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => 
                            <View>
                                ...
                                <Text style={{  color: 'white', fontSize: 20, fontFamily: "Crabmeal",left:20 }}>{item.skill}</Text>
                                    <Text style={{  color: 'white', fontSize: 20, fontFamily: "Crabmeal",textAlign:'right',right:20 }}>{item.statusskill}</Text>
                                </View>
                            </View>
                        }                      
